...
if ($iduser == 0) {
    ...
    $query = 'SELECT * FROM `thanhtoan` WHERE trangthai = 1 ORDER BY `thanhtoan`.`id` DESC';
} else {
    $query = 'SELECT * FROM `thanhtoan` WHERE  `iduser` = ' . $iduser . ' AND trangthai = 1  ORDER BY id DESC';
}
