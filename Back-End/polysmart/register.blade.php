        ...
        <div class="container">
            <div class="card bg-light" style="border: none">
                <article class="card-body mx-auto" style="max-width: 400px;">
                    <form method="POST" action="submit_new.php" id="form-register" enctype="multipart/form-data">
                        <!-- form-group// -->
                        ...
                        <div class="form-group input-group">
                            ...
                            <input name="" class="form-control password_confirmation" placeholder="Nhập lại Mật khẩu"
                                type="password">
                            <span style="font-size: 15px; color: #f33a58;width: 100%;" class="form-message"></span>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit_password" class="btn btn-lg btn-block btn-form"> Đăng ký tài khoản
                            </button>
                        </div> <!-- form-group// -->
