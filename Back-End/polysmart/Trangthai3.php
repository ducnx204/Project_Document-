...
if ($iduser == 0) {
    ...
    $query = 'SELECT * FROM `thanhtoan` WHERE trangthai = 3 ORDER BY `thanhtoan`.`id` DESC';
} else {
    $query = 'SELECT * FROM `thanhtoan` WHERE  `iduser` = ' . $iduser . ' AND trangthai = 3  ORDER BY id DESC';
}
